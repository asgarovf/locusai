...
import { AssistantMessage, UserMessage } from "@/components/chat/types";
...
export default function SharedChatPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      {/* Public Header */}
      <header className="flex items-center gap-3 p-4 border-b border-border/40 bg-background/50 backdrop-blur-md sticky top-0 z-10 h-16">
        ...
        <div className="flex flex-col min-w-0">
          <span className="font-semibold text-sm truncate">Shared Chat</span>
      ...
      {/* Messages */}
      <main className="flex-1 overflow-y-auto p-4 md:px-8 lg:px-12 bg-linear-to-b from-background to-secondary/10">
        <div className="max-w-5xl mx-auto space-y-8 py-8">
          <div className="bg-primary/5 border border-primary/10 rounded-xl p-4 mb-8 flex items-start gap-4">
            ...
            <div>
              <h3 className="text-sm font-semibold">Publicly Shared Chat</h3>
              <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                You are viewing a conversation shared via Locus AI. This is a
