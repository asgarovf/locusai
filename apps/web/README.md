...
<p align="center">
  <a href="https://www.npmjs.com/package/@locusai/web"><img src="https://img.shields.io/npm/v/@locusai/web?color=blue" alt="npm version" /></a>
...
- **Documentation Editor** with Markdown support
- **CI Monitor** for real-time build status
- **Dark Mode** with modern, responsive design
...
The Locus dashboard provides:
- Drag-and-drop Kanban board
- Task detail panels with acceptance checklists
- Documentation tree explorer
- CI run logs and artifacts
