...
const commands = [
  ...
  },
  {
    name: "locus discuss",
    description:
      "Start interactive AI discussions with project context. Extracts structured insights as the conversation progresses.",
  ...
  },
  {
    name: "locus version",
    description:
      "Show installed version of the Locus CLI and related packages.",
