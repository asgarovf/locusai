# Discussion: I want to expand the locus services to launch an AWS instance so that people can launch their agent server and add integrations. What do you think?
...
**Created:** 2026-02-18T16:29:08.698Z
**Updated:** 2026-02-18T17:30:53.516Z
**Model:** opus (claude)

## Messages (39)

### Assistant — 2026-02-18T16:29:18.032Z

Hey! I'm here to help you think through this expansion. Launching AWS instances for agent server hosting is a significant infrastructure move, so let's make sure we nail the details.
...
### User — 2026-02-18T16:32:41.593Z

I mean it is difficult to launch your own server, clone your working repo there, install claude or codex, then manage the integration versions, etc etc. We have an easy installation script but it is still difficult to launch if you don't know much about AWS, Azure and other services.

### Assistant — 2026-02-18T16:32:52.590Z

That makes a lot of sense. So the core value prop is **removing the infrastructure complexity** — users shouldn't need to know AWS/Azure to get a running agent server with their repo and integrations ready to go.
...
### User — 2026-02-18T16:33:24.481Z

Yes, individual developers in the beginning.

### Assistant — 2026-02-18T16:33:33.713Z

Good, starting with individual developers keeps the scope manageable and lets you iterate on the experience before tackling team-level complexity.
...
### User — 2026-02-18T16:34:57.075Z

Not shure about it, what do you recommend. The goal is simple, it should listen to user requests from telegram or future integrations and then execute commands locally and then push the changes. I think it should be persistent because otherwise how we will manage the hosting repository there?

### Assistant — 2026-02-18T16:35:11.446Z
...
### User — 2026-02-18T16:35:56.785Z

Which one do you recommend?

### Assistant — 2026-02-18T16:36:13.496Z

Great question — both models have real trade-offs, so let me give you a clear recommendation.
...
### User — 2026-02-18T16:37:28.052Z

Makes sense to be orchestrator then

### Assistant — 2026-02-18T16:37:37.266Z

Good call. The orchestrator model gives you the best of both worlds — simple UX without the operational burden of being a hosting provider.
...
### User — 2026-02-18T16:45:09.792Z

LLM API keys will not work. Therefore, provide a web based terminal in the locus dashboard makes sense

### Assistant — 2026-02-18T16:45:21.218Z

Good choice — a web-based terminal solves the auth problem cleanly without requiring users to know SSH, and it keeps the experience within the Locus dashboard.
...
### User — 2026-02-18T16:51:35.244Z

We can notify the user about the situation and force them somehow to take an action manually

### Assistant — 2026-02-18T16:51:49.162Z
...
### User — 2026-02-18T16:52:22.810Z

User will request and update from the dashboard and we will trigger the update

### Assistant — 2026-02-18T16:52:33.324Z

Smart choice — user-triggered updates give you control without the risk of breaking a running agent mid-task. You can show available updates in the dashboard and let users apply them when they're ready.
...
### User — 2026-02-18T16:57:13.853Z

We can simply make it equal to aws cost itself. Later, we can restrict this access on our application level so that premium users will only have access to it

### Assistant — 2026-02-18T16:57:26.811Z

Interesting pricing approach — matching AWS cost means you're essentially offering the orchestration for free initially, then monetizing it later by gating access behind a premium tier. That's a solid growth strategy: remove all friction now to drive adoption, then capture value once users depend on it.
...
### User — 2026-02-18T17:21:12.991Z

Does not AWS show the billing in a transparent way? Users can go to their aws account and check, am I wrong?

### Assistant — 2026-02-18T17:21:27.561Z

You're absolutely right — AWS does show billing transparently in their console. Individual developers on small instances can easily check their own AWS billing dashboard. Adding a cost estimation layer inside Locus would be extra engineering effort for relatively little value at this stage, especially since you're targeting technically capable individual developers who already have AWS accounts.
...
### User — 2026-02-18T17:22:26.737Z

I think narrow permission set is enough because there is not too much thing we will do. Just launch a server, ssh into it, install some stuff, and run some commands inside the instance. That is it

### Assistant — 2026-02-18T17:22:40.106Z

You're right — for this use case, the permission set is quite narrow. You basically need: `ec2:RunInstances`, `ec2:DescribeInstances`, `ec2:StartInstances`, `ec2:StopInstances`, `ec2:TerminateInstances`, and some security group permissions. That's a very tight scope, which makes the IAM setup straightforward and builds user trust since they can see exactly what Locus can do in their account.
...
### User — 2026-02-18T17:23:19.824Z

Hmm, is there a cost difference for these custom instances? If no we can continue with it

### Assistant — 2026-02-18T17:23:39.616Z
...
### User — 2026-02-18T17:23:50.231Z

Default is fine

### Assistant — 2026-02-18T17:24:01.075Z

Good call — defaulting to a single region like `us-east-1` keeps the provisioning logic simple and avoids the complexity of managing AMIs across multiple regions. You can always add region selection later if user demand warrants it.
...
### User — 2026-02-18T17:24:33.987Z

We already have a way on installation where user provides the github access token. I think this is ideal

### Assistant — 2026-02-18T17:24:48.101Z

That's great — reusing the existing GitHub access token flow during installation means the repo connection is already solved. The provisioning script can clone the repo automatically using the token the user already provided, and the agent can push commits back using the same credentials. No new UX needed for this step.
...
### User — 2026-02-18T17:25:37.453Z

We definitely need to handle them, but maybe in the future. On initial step, not very crucial

### Assistant — 2026-02-18T17:25:49.390Z

That's a pragmatic approach — edge cases like instance crashes, disk full, and recovery scenarios are important but can absolutely be deferred to a later iteration. For an MVP targeting individual developers, the core provisioning and management flow is what matters most.
...
### User — 2026-02-18T17:29:48.202Z

Yeah lets do it

### Assistant — 2026-02-18T17:30:53.516Z

The comprehensive summary has been saved to `.locus/artifacts/aws-instance-orchestration-prd.md`. It covers everything we discussed:
...
### [REQUIREMENT] One-click agent server deployment

Users need to be able to launch an agent server without needing cloud infrastructure knowledge (AWS, Azure, etc.). The current installation script exists but still requires users to provision and configure their own servers.

**Tags:** infrastructure, ux, deployment

### [LEARNING] Current pain points in self-hosting

The current workflow requires users to: 1) Launch a cloud instance manually, 2) Clone their working repo, 3) Install Claude/Codex, 4) Manage integration versions. Even with an installation script, this is too complex for users without cloud experience.

**Tags:** user-research, pain-points

### [DECISION] Initial target: individual developers

The first version of the managed hosting feature will target individual developers, not teams or companies. Team/shared service use cases will come later.

**Tags:** target-audience, mvp, scope

### [DECISION] Persistent always-on instances
...
### [IDEA] Infrastructure orchestrator model over hosting provider

Locus should orchestrate instance provisioning in the user's own AWS account rather than hosting instances on Locus-owned infrastructure. This avoids becoming a hosting provider (billing complexity, abuse risk, uptime liability) while still enabling a one-click experience. Users pay AWS directly, keep their code/keys in their own account, and connect via IAM role or access keys.

**Tags:** architecture, business-model, aws, hosting

### [DECISION] Infrastructure orchestrator model confirmed

Locus will act as an infrastructure orchestrator, provisioning instances in the user's own AWS account rather than hosting on Locus-owned infrastructure. Users connect their AWS account via IAM role or access keys, and Locus handles all provisioning and setup transparently.

**Tags:** architecture, aws, hosting-model

### [CONCERN] LLM CLI authentication requires manual server login

Claude CLI and Codex require interactive credential-based login (not just an API key). This means users must SSH into the provisioned instance at least once to authenticate, which adds friction to the onboarding flow and partially breaks the one-click deployment promise.

**Tags:** authentication, onboarding, ux, blocker

### [DECISION] Web-based terminal for LLM CLI authentication

Locus will provide a web-based terminal embedded in the dashboard so users can authenticate Claude CLI and Codex interactively on the provisioned instance without needing SSH knowledge. This preserves the managed experience while accommodating CLIs that require interactive login rather than API key injection.

**Tags:** onboarding, authentication, ux, dashboard

### [DECISION] Graceful degradation on subscription lapse

When a user's Locus subscription lapses, Locus will notify the user and stop managing/orchestrating the instance after a grace period. The instance continues running in the user's AWS account but loses Locus-managed updates and integration management. Users must take manual action to either re-subscribe or terminate the instance themselves.

**Tags:** billing, lifecycle, subscription

### [DECISION] User-triggered updates from dashboard

Locus agent software updates on remote instances will be user-initiated through the dashboard, not automatic. When a new version is available, the user sees it in the dashboard and triggers the update manually. This avoids the risk of auto-updates breaking an agent mid-task while keeping instances up to date.

**Tags:** updates, deployment, dashboard

### [DECISION] Telegram handles agent activity monitoring
...
### [DECISION] Instance security: password + IP restriction recommendations

Provisioned AWS instances will be password-protected at the AWS level. The Locus dashboard will recommend IP restrictions to users, making SSH access restrictive. This provides a reasonable security baseline for individual developers while keeping direct SSH access available when needed.

**Tags:** security, aws, instance-management

### [DECISION] Pricing: at-cost initially, premium-gated later

The AWS hosting orchestration will initially be priced at AWS cost (no markup), making it essentially free orchestration. Later, access to this feature will be restricted to premium/paid tier users only, creating a conversion lever once users depend on the managed hosting experience.

**Tags:** pricing, monetization, growth-strategy

### [DECISION] No in-app cost estimation — rely on AWS billing

Locus will not build a cost estimation or billing transparency feature in the dashboard. Users will rely on AWS's own billing console to track instance costs. This avoids the complexity of integrating with AWS Cost Explorer API and is sufficient for the individual developer target audience.

**Tags:** billing, dashboard, scope

### [DECISION] Minimal AWS permissions scope

Locus will request a narrow set of AWS permissions limited to EC2 instance lifecycle management (launch, start, stop, terminate, describe) and basic security group configuration. No broad IAM, S3, or other service permissions needed. This keeps the IAM role/policy simple and builds user trust through transparency.

**Tags:** aws, security, permissions, onboarding

### [DECISION] Custom AMI for fast provisioning

Locus will maintain a custom AMI with all dependencies pre-installed (Node.js, Git, Claude CLI, Codex, Locus agent) for fast instance provisioning. There is no meaningful cost difference versus a standard Ubuntu AMI. Incremental updates after initial provisioning will be handled through the dashboard update mechanism.

**Tags:** aws, provisioning, ami, infrastructure

### [DECISION] Default single AWS region

Locus will default to a single AWS region (e.g., us-east-1) for instance provisioning rather than offering multi-region selection. This simplifies AMI management and provisioning logic. Multi-region support can be added later based on user demand.

**Tags:** infrastructure, aws, provisioning

### [DECISION] GitHub repo connection via existing access token flow

The provisioned instance will connect to the user's GitHub repo using the GitHub personal access token already collected during the existing Locus installation/onboarding flow. This token handles both cloning the repo during provisioning and pushing commits back. No new authentication mechanism is needed for GitHub integration.

**Tags:** github, authentication, onboarding, provisioning

### [DECISION] Edge cases deferred to future iterations

Handling edge cases such as instance crashes, disk full, and recovery scenarios will be deferred to future iterations. The initial version will focus on the core provisioning, management, and update flow for individual developers.

**Tags:** scope, mvp, prioritization

---
*Discussion ID: disc-1771432148704*